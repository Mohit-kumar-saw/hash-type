        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="max-w-xs">
            ...
            <p className="mt-3 text-gray-400 text-sm leading-relaxed">
              Launch your own Software As A Service Application with HashType. 
              Master typing with our advanced tools.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-12">
            <div className="flex flex-col space-y-3">
              ...
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">Features</a>
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">FAQs</a>
            </div>
            <div className="flex flex-col space-y-3">
              <h3 className="text-white font-semibold mb-2">Company</h3>
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">Careers</a>
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">Learn</a>
            </div>
            <div className="flex flex-col space-y-3">
          ...
          <div className="flex flex-col items-start">
            <div className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg transition-all flex items-center gap-2 cursor-pointer">
